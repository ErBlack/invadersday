...
<section class="content">
    ...
    <p class="text">
        ...
        <br/><br/>
        date: october, {start.getDate()} in {start.getHours()}:{String(start.getMinutes()).padStart(2, '0')}
        <br/>
        address: <a href="https://yandex.ru/maps/-/CCUZIMBlkA">📍 street Rajićeva house 3</a> apt 2a
        <br/><br/>
        <Timer start={start}/>
    </p>
    <Links/>
